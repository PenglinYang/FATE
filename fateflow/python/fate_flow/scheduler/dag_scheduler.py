    ...
    def submit(cls, submit_job_conf: JobConfigurationBase, job_id: str = None):
        ...
        try:
            ...
            if common_job_parameters.job_type != "predict":
                ...
                train_runtime_conf = {}
# ###################### this may be the position to insert parameter about module remote attestation information
# ###################### like source code link, source code image, etc.
            else:
            ...
            JobController.create_common_job_parameters(job_id=job.f_job_id,
                                                       initiator_role=job.f_initiator_role,
                                                       common_job_parameters=common_job_parameters)
# ##########common_job_parameters 包括module的信息，但是好像没有什么用
